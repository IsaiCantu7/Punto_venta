        ...
        <form action="{{ route('productos.update', $producto->id) }}" method="POST" class="max-w-xl bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="Color(es)" id="Color(es)" value="{{ $producto->Color(es) }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
            </div>
